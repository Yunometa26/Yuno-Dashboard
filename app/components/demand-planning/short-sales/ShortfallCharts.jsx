...
export default function ShortfallCharts({ data, selectedMonth, selectedFY, selectedCategory }) {
  ...
  useEffect(() => {
    ...
    if (selectedMonth) {
      ...
      filteredData = filteredData.filter((item) => item.Months?.split("-")[0] === monthNum)
    }
    ...
    // Initialize all months with default shortfall 0
    const monthlyData = {}
    Object.values(monthNames).forEach(monthName => {
      monthlyData[monthName] = { month: monthName, shortfall: 0, count: 0 }
    })
        ...
        <div className="bg-white rounded-lg shadow-md p-6 h-96 flex flex-col items-center justify-center">
          <svg className="w-16 h-16 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
              d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 002 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
          </svg>
      ...
      <div className="bg-gradient-to-br from-[#024673] to-[#5C99E3] rounded-lg shadow-md p-4 h-96">
        ...
        <ResponsiveContainer width="100%" height="85%">
          <PieChart>
            ...
            <Legend payload={categoryShortfallData.map((item, index) => ({
              id: item.name,
              type: 'square',
