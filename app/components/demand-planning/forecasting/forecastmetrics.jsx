    ...
    <div className="p-6 rounded-xl backdrop-blur-md bg-white/5 border border-white/20 shadow-md text-white">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div className="relative bg-gradient-to-r from-[#024673] to-[#5C99E3] p-4 rounded-xl shadow-sm border border-blue-200 text-white">
          <h3 className="text-sm text-white/80 mb-2">Latest Forecast</h3>
          <div
            className="absolute top-1/2 right-4 transform -translate-y-1/2 w-9 h-9 bg-white rounded-lg flex items-center justify-center cursor-pointer hover:bg-gray-100"
        ...
        <div className="relative bg-gradient-to-r from-[#024673] to-[#5C99E3] p-4 rounded-xl shadow-sm border border-blue-200 text-white">
          ...
          <div className="absolute top-1/2 right-4 transform -translate-y-1/2 w-9 h-9 bg-white rounded-lg flex items-center justify-center">
            <img
              src="/accuracy.png"
              alt="Accuracy Icon"
      ...
      {showTable && (
        <div className="mt-6 overflow-x-auto max-h-[500px] rounded-lg backdrop-blur-md bg-white/5 border border-white/10">
