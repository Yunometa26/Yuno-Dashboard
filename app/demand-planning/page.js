...
import { ChartLine, ShoppingBag, Target } from 'lucide-react';
...
export default function DemandPlanningPage() {
  const cards = [
    { 
      ...
      path: "/demand-planning/forecasting",
    ...
    { 
      ...
      path: "/demand-planning/short-sales",
      borderColor: "bg-green-500"
    },
    { 
      id: 3, 
      title: "Micromarketing Strategy", 
      icon: <Target className="h-8 w-8 text-purple-500" />, 
      path: "/demand-planning/micromarketing",
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-8">
                  ...
                  <div className="flex-1 space-y-5 align-middle text-center">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white leading-tight">
                      Welcome to Yunometa <span className="text-white">Demand Planning</span>
                    </h2>
                  </div>
                </div>
              </div>
